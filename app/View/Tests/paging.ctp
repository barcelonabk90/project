...
/*            $LM = $question['Question']['LM'];
            $delimiter = ',';
            $arr = str_getcsv($LM, $delimiter);
            //print_r($arr);
            echo "<br/>";
            $TM = $question['Question']['TM'];
            //echo "Time :".$TM;
            //echo "<br/>";
            if(count($arr)== 3){
                $m = $arr[1];
            ...
            //echo "Time : ".$m."m,".$s."s";
            //echo '<label id="questionID">'.$question["Question"]["questionID"].'</label>';
            //echo '<label id="questionTime">'.$time.'</label>';
  ...
  */          
            ...
            echo "Time for this question is ";
            $LM = $question['Question']['LM'];
            $delimiter = ',';
            $arr = str_getcsv($LM, $delimiter);
            ...
            if($question['Question']['TM']!='-1')
{
            ...
            echo '<p style="display:none"> 問題の時間 <input name="Time['.$questionID.']"  value = "0" id = "testtime'.$questionID.'" > senconds </p>';
}
...
<?php echo '<input type="submit" name="submit" id="btaction" value = "submit" />';
